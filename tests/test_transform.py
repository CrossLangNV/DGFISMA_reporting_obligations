...
@pytest.mark.parametrize("get_path_json, get_path_pickle, get_path_typesystem", [
                       ("small_nested_tables_response.json", "small_nested_tables_nested_lines.p", "typesystem.xml" ), 
                       ("minus_lesser_of_response.json", "minus_lesser_of_nested_lines.p", "typesystem.xml" ) ,
                       ("doc_bf4ef384-bd7a-51c8-8f7d-d2f61865d767_response.json", "doc_bf4ef384-bd7a-51c8-8f7d-d2f61865d767_nested_lines.p", "typesystem.xml" ) ,
                       ("double_nested_list_response.json", "double_nested_list_nested_lines.p", "typesystem.xml" ) ],  
                         indirect=["get_path_json", "get_path_pickle", "get_path_typesystem"  ])
def test_get_other_lines( get_path_json, get_path_pickle, get_path_typesystem ):
